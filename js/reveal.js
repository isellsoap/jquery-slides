...
var Reveal = (function(){
	...
	function slide() {
		...
		writeURLTimeout = setTimeout( writeURL, 600 );
	...
	var childEl1 = document.getElementById("indicator1"),
		childEl2 = document.getElementById("indicator2");
 
	if ( +bits[0] > 0 && +bits[0] < 9 ) {
		childEl1.innerHTML = "<span><a href='#/1'>Überblick</a></span>&nbsp;&nbsp;&nbsp;<a href='#/9'>Basiskonzepte</a>&nbsp;&nbsp;&nbsp;<a href='#/16'>Beispiele</a>&nbsp;&nbsp;&nbsp;<a href='#/21'>Plugins</a>";
	} else if ( +bits[0] > 8 && +bits[0] < 16 ) {
		childEl1.innerHTML = "<a href='#/1'>Überblick</a>&nbsp;&nbsp;&nbsp;<span><a href='#/9'>Basiskonzepte</a></span>&nbsp;&nbsp;&nbsp;<a href='#/16'>Beispiele</a>&nbsp;&nbsp;&nbsp;<a href='#/21'>Plugins</a>";
	} else if ( +bits[0] > 15 && +bits[0] < 21 ) {
		childEl1.innerHTML = "<a href='#/1'>Überblick</a>&nbsp;&nbsp;&nbsp;<a href='#/9'>Basiskonzepte</a>&nbsp;&nbsp;&nbsp;<span><a href='#/16'>Beispiele</a></span>&nbsp;&nbsp;&nbsp;<a href='#/21'>Plugins</a>";
	} else if ( +bits[0] > 20 && +bits[0] < 25 ) {
		childEl1.innerHTML = "<a href='#/1'>Überblick</a>&nbsp;&nbsp;&nbsp;<a href='#/9'>Basiskonzepte</a>&nbsp;&nbsp;&nbsp;<a href='#/16'>Beispiele</a>&nbsp;&nbsp;&nbsp;<span><a href='#/21'>Plugins</a></span>";
	} else {
		childEl1.innerHTML = "<a href='#/1'>Überblick</a>&nbsp;&nbsp;&nbsp;<a href='#/9'>Basiskonzepte</a>&nbsp;&nbsp;&nbsp;<a href='#/16'>Beispiele</a>&nbsp;&nbsp;&nbsp;<a href='#/21'>Plugins</a>";
	}
	
	
	childEl2.innerHTML = +bits[0] + 1 + " von 28";
